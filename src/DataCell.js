...
class DataCell extends React.Component {
  ...
  render() {
    ...
    return (
      <div className={classNames({'active': this.props.active, 'pinned': this.props.pinned, 'expanded': this.props.expanded, 'data-cell': true})} onClick={() => this.props.setAsActiveCell(this.props.cell.id)}>
